      ...
      {                                   //until user types 'q'
        ...
        switch (choice)
        {
          ...
          case 't':                        //traverse the tree
            ...
            break;
          case 'm':
            int minInteger = theTree.findMin();
            Console.WriteLine("Min integer is {0}", minInteger);
            break;
